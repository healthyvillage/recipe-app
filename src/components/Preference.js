...
const preference = ({ setQuery }) => {
  ...
  const preferenceKeto = (e) => {
    const preferenceID = document.getElementById("keto").innerText;
    setQuery(preferenceID);
    console.log(preferenceID)
    addClass(e);
  }
  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <a id="keto" className="tag" onClick={preferenceKeto} value="keto">
            Keto
          </a>
        </li>
        <li>
